...
<body>
	...
	<div clss="container">
		...
		<div align="center">
			...
			<form action="php/post_marker.php" method="post" enctype="multipart/form-data">
				<table>
		...
		function myMap() {
			...
			function userMarker(){
				for (var i = locUsers.length - 1; i >= 0; i--) {
					//window.alert("Number is "+ locUsers[i][7]);
					markerUser = new google.maps.Marker({
						position: {lat: parseFloat(locUsers[i][1]), lng: parseFloat(locUsers[i][2])},
						map: map,
						animation: google.maps.Animation.DROP,
						icon: locUsers[i][5] === '1' ? (locUsers[i][6] === '1' ? 'Icon/markers/marker-blue45px.png' :'Icon/markers/markergreen45px.png') : 'Icon/markers/marker-yellow45px.png',
						title: locUsers[i][3],
