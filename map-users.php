	...
	if(isset($_SESSION['timeEla'])){
		if((time() - $_SESSION['timeEla'])>=1200){
			...
			?> <script type="text/javascript">
				...
				window.location.href = "http://localhost:82/Assignment-WEB/Phase%2004/Phase%2002/map-visit.php";
			</script> <?php
		}
	}
...
<body>
	...
	<div clss="container">
		...
		<div id="pop1">
			...
			<h2>Get an idea about MAP Markers.</h2>
			<img src="image\Markers 3.jpg" width="500" alt="Guide"/>
			<p>Click OK to Continue...</p>
			<button id="btn3" class="btn btn-lg btn-success" onclick="pop()">OK</button>
		</div>
		...
		<div align="center">
			...
			<form action="php/post_marker_u.php" method="post" enctype="multipart/form-data">
				<table>
		...
		function myMap() {
			...
			function addGen(){
				//window.alert("Number is "+ n);
                    ...
                    '<div class="iw-content">' +
                      '<p">'+locUsers[n][4]+'</p><img src="php/Locations/'+locUsers[n][7]+'" alt ="location" height="120"/><br><center><table><tr><td><input type="hidden" value = "'+parseInt(locUsers[n][0])+'" name="ID"></td></tr><tr><td><button id="btnsub" name="submit2" class="btn btn-success" >SHOW</button></td><td><button id="cancel" name="dec" class="btn btn-danger" onclick="addGen()">NEXT</button></td></tr></table></center>'+'</div>';
			...
			google.maps.event.addListener(map, 'click', function(event){
				...
				count += 1;
				markerAdd({coords:event.latLng,icon:'Icon/markers/marker-purple45px.png', content: mDraft3});
			...
			*/
			...
			var arr = [{coords:{lat: 6.8433, lng: 80.0032}, icon:'Icon/flagIcon 50px.png', content:mDraft2}, {coords:{lat: 6.9497, lng: 80.7891}, content: mDraft}, {coords:{lat: 7.2906, lng: 80.6337}}, {coords:{lat: 8.5874, lng: 81.2152}}];
